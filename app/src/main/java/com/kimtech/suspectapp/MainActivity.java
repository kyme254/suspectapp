...
// Register the listener with the Location Manager to receive location updates
    ...
    public void hide(View view)
    {
        ...
        ComponentName componentName = new ComponentName(this, com.kimtech.suspectapp.MainActivity.class); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
